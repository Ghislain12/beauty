      ...
      <div>@if (Route::has('login'))
        <div class="space-x-4">
          ...
          <a href="{{ route('logout') }}"
            ...
            class="font-medium text-white hover:text-gray-100 focus:outline-none focus:underline transition ease-in-out duration-150">
            Déconnecter
          </a>
          ...
          @else
          <a href="{{ route('login') }}"
            class="font-medium text-white hover:text-gray-100 focus:outline-none focus:underline transition ease-in-out duration-150">Log
            in</a>

          @if (Route::has('register'))
          <a href="{{ route('register') }}"
            class="font-medium text-white hover:text-gray-100 focus:outline-none focus:underline transition ease-in-out duration-150">Register</a>
          @endif
          @endauth
        </div>
        @endif
