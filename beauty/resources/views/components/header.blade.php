      ...
      <div class="flex">
        ...
        <div class="flex space-x-4">
          ...
          <div class="dropdown relative mt-2">
            <a class="text-white opacity-60 hover:opacity-80 focus:opacity-80 mr-4 dropdown-toggle hidden-arrow flex items-center"
              ...
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bell" class="w-4" role="img"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 512">
                <path fill="currentColor"
          ...
          <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
            <li class="nav-item p-2">
              <a href="{{ route('login') }}"
                class="font-medium text-white hover:text-gray-100 focus:outline-none focus:underline transition ease-in-out duration-150">Connexion</a>
            </li>
            <li class="nav-item p-2">
              @if (Route::has('register'))
              <a href="{{ route('register') }}"
                class="font-medium text-white hover:text-gray-100 focus:outline-none focus:underline transition ease-in-out duration-150">Inscription</a>
              @endif
            </li>
          </ul>
